...
public class FrmEmpleados extends javax.swing.JFrame {
    ...
    public FrmEmpleados(GestorDeGestores gg) {
        this();
        this.gg = gg;
        this.gestorEmpleados = gg.getGestorEmpleados();
        configurarTabla();
        cargarTabla();
    }
    ...
    private void cargarTabla() {
        limpiarTabla();
        Empleado[] arr = gestorEmpleados.getEmpleados();
        int cant = gestorEmpleados.getCantidad();
    ...
    private void initComponents() {
        ...
        btnCerrar2.setBackground(new java.awt.Color(247, 196, 196));
        btnCerrar2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btnCerrar2.setForeground(new java.awt.Color(74, 28, 28));
        ...
        cbRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Recepcionistas", "Médicos", "Enfermeros(as)", "Cajeros", "Administradores" }));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel5)
                    .addComponent(cbRol, javax.swing.GroupLayout.PREFERRED_SIZE, 22, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (dni.equals("") || nombres.equals("") || apellidos.equals("") || usuario.equals("") || password.equals("")) {
            JOptionPane.showMessageDialog(this, "DNI, Nombres, Apellidos, Usuario y Password son obligatorios");
            return;
        }

        Empleado e = new Empleado(dni, nombres, apellidos, rol, especialidad, telefono, email, usuario, password);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String dni = txtDNI.getText();
        if (dni.equals("")) {
            JOptionPane.showMessageDialog(this, "Ingrese DNI para buscar");
            return;
        }

        Empleado e = gestorEmpleados.buscarPorDni(dni);
        if (e == null) {
            JOptionPane.showMessageDialog(this, "Empleado no encontrado");
        } else {
            txtNombres.setText(e.getNombres());
            txtApellidos.setText(e.getApellidos());
            cbRol.setSelectedItem(e.getRol());
